const { get } = require("../server/controllers/journalcontroller");
...
function displayByTitle() {
    ...
    let jrnlTitle = document.getElementById('searchBar').value;
    console.log(jrnlTitle);
    fetch(`http://localhost:3000/journal/${jrnlTitle}`, {
        method: "GET",
        headers: new Headers({
            "Content-Type": "application/json",
        })
